namespace ShareQ.Core.Imaging;

/// <summary>Re-encodes raw image bytes into a different format. Implemented in
/// <c>ShareQ.App</c> against WPF's <see cref="System.Windows.Media.Imaging.BitmapEncoder"/>
/// family — kept behind an interface here so <c>ShareQ.Pipeline</c> (and other non-WPF
