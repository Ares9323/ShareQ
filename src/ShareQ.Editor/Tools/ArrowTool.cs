...
public sealed class ArrowTool : IDrawingTool
{
    ...
    public EditorTool Kind => EditorTool.Arrow;
    ...
    public void Begin(double x, double y, ShapeColor outline, ShapeColor fill, double strokeWidth)
    {
        ...
        _active = true;
        PreviewShape = new ArrowShape(_startX, _startY, x, y, _outline, _strokeWidth);
    }
    ...
    public Shape? Commit(double x, double y)
    {
        ...
        return new ArrowShape(_startX, _startY, x, y, _outline, _strokeWidth);
    }
}
