...
public class TextShapeTests
{
    ...
    {
        var t = new TextShape(10, 20, "Hello", TextStyle.Default, ShapeColor.Red, ShapeColor.Transparent, 1);
        Assert.Equal(10, t.X);
        Assert.Equal(20, t.Y);
    ...
    {
        var t = new TextShape(0, 0, "   ", TextStyle.Default, ShapeColor.Red, ShapeColor.Transparent, 1);
